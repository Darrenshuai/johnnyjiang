var App = function() {
    ...
    var userTypelist = {
            91000: '<li><a href="userquery.html"><i class="fa fa-user"></i><span class="title">用户管理</span><span class="arrow"></span></a><ul class="sub-menu useropt"><li><a href="userquery.html">用户信息检索</a></li></ul></li>', //查询用户
            91001: true, //改变用户状态
            91002: true, //改变用户录音状态
            91003: true, //删除用户头像
            92000: '', //查询用户提现
            ...
            96002: '', //获得好友申请列表
            97000: '', //抽奖
            98000: '<li><a href="phonequery.html"><i class="fa fa-phone"></i><span class="title">通话记录查询</span></a></li>', //通话记录查询
            99000: '', //刷新兴趣标签
            99001: '', //搜索兴趣标签
            99002: '', //更改兴趣标签
            10000: '' //搜索红包
    ...
    return {
        ...
        getMenu: function(callback) {
            ...
            var sec = $(list);
            for (i; i < d.length; i++) {
                if (d[i] in userTypelist) {
                    if (d[i] == '94000') {
                        $(sec).find('.useropt').append($(userTypelist[d[i]]));
                    } else if (d[i] == "91001") {
                        changestatus = userTypelist[d[i]];
                    } else if (d[i] == "91002") {
            ...
            $(sec).appendTo('.page-sidebar');
            var url=window.location.href.split('/'),c=url[url.length-1];
            var p=$('.page-sidebar').find('a[href="'+c+'"]');
